...
<title>Evidence-First AI Diligence</title><link rel="stylesheet" href="assets/styles.css"></head>
<body><main>
...
<section><h2>Claim ledger</h2><div class="table-wrap"><table><thead><tr><th>ID</th><th>State</th><th>Claim</th></tr></thead><tbody>{rows}</tbody></table></div></section>
...
STYLES = """
:root{color-scheme:dark;--bg:#07110f;--panel:#10201b;--ink:#edf8f2;--muted:#a9c1b6;--accent:#75f0ad;--line:#29463b}*{box-sizing:border-box}body{margin:0;background:radial-gradient(circle at top right,#173c2f 0,#07110f 42%);color:var(--ink);font:16px/1.6 system-ui,sans-serif}main,footer{width:min(1080px,calc(100% - 32px));margin:auto}main{padding:72px 0}.eyebrow{letter-spacing:.16em;color:var(--accent);font-weight:750}h1{font-size:clamp(2.6rem,8vw,6.7rem);line-height:.95;max-width:900px;margin:.2em 0}.lede{font-size:clamp(1.15rem,2.5vw,1.6rem);max-width:760px;color:var(--muted)}aside,article{border:1px solid var(--line);background:color-mix(in srgb,var(--panel) 88%,transparent);padding:22px;border-radius:16px}section{margin-top:72px}.grid{display:grid;grid-template-columns:repeat(auto-fit,minmax(260px,1fr));gap:16px}article span{display:block;color:var(--muted)}article strong{font-size:1.5rem;color:var(--accent)}.table-wrap{overflow-x:auto}table{border-collapse:collapse;width:100%;background:var(--panel)}th,td{text-align:left;vertical-align:top;padding:14px;border-bottom:1px solid var(--line)}th{color:var(--accent)}code{overflow-wrap:anywhere;color:var(--accent)}a{color:var(--accent)}a:focus-visible{outline:3px solid #fff;outline-offset:3px}footer{padding:30px 0 60px;color:var(--muted)}@media(prefers-reduced-motion:reduce){*{scroll-behavior:auto!important}}""".strip() + "\n"
