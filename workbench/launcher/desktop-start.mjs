...
const server=await startLocalDesk({workbenchPath:root,storePath:join(home,'reviews.sqlite'),port:0,desktop:{version:'0.3.1-local',openExtension:()=>openFile(join(root,'Underwriting Desk.mcpb')),quit:()=>server.close()}});
