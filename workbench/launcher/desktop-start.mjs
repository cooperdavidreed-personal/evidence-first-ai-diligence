...
const server=await startLocalDesk({workbenchPath:root,storePath:join(home,'reviews.sqlite'),port:0,desktop:{version:'0.3.4-local',readExtension:()=>readFile(join(root,'Underwriting Desk.mcpb')),openExtension:()=>openFile(join(root,'Underwriting Desk.mcpb')),quit:()=>server.close()}});
