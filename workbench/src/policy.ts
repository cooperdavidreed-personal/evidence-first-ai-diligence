...
export const HELIOS_SCREEN_POLICY: PolicyProfile = {
  ...
  lastReviewed: null,
  thresholds: [
    {thresholdId: "helios-nrr", label: "Minimum ordinary-cohort NRR", metric: "ordinary_nrr", operator: ">=", value: 0.95, displayValue: "95.0%", owner, ownerRole: "Policy owner", source: "Desk-owned public demonstration policy — separate from the retained synthetic data room", status: "DRAFT", lastReviewed: null, rationale: "A sub-95% ordinary-cohort result requires explicit retention diligence and policy-owner disposition."},
    {thresholdId: "helios-margin", label: "Minimum fully burdened gross margin", metric: "gross_margin", operator: ">=", value: 0.7, displayValue: "70.0%", owner, ownerRole: "Policy owner", source: "Desk-owned public demonstration policy — separate from the retained synthetic data room", status: "DRAFT", lastReviewed: null, rationale: "Numeric screen only; provider, support and implementation cost completeness still require review."},
    {thresholdId: "helios-runway", label: "Post-close modeled runway floor", metric: "runway_months", operator: ">=", value: 18, displayValue: "18.0 modeled months", owner, ownerRole: "Policy owner", source: "Desk-owned public demonstration policy — separate from the retained synthetic data room", status: "DRAFT", lastReviewed: null, rationale: "Screens modeled post-close runway under the selected financing case. The separate 17.3-month headline describes recent pre-financing runway."},
