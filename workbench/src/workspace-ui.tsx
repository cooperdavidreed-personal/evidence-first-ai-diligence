...
export function DiligenceWorklist({state, update, lockedIssueIds = new Set<string>(), stages}: {state: DealWorkspaceState; update: WorkspaceUpdate; lockedIssueIds?: ReadonlySet<string>; stages?: ReadonlyMap<string, string>}) {
