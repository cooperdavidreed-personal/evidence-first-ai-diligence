...
- Portable workspace import preserves proposal content and named human disposition but strips model-family attribution, labels provider origin unverified, and drops policy exceptions so they must be re-recorded locally; the public slice does not claim cryptographic provider or human-authority attestation.
