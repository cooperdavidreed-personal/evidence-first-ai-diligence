...
| HX-06 | ITT of optimizer assignment on change in log unit cost. | Seed-permuted 60-of-120 assignment. | Neyman interval; balance SMD <= 0.15. | Cost or customer-savings milestone only when the economic mapping is explicit. |
