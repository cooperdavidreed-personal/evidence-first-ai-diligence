...
STUDY_DESIGNS: dict[str, dict[str, Any]] = {
    ...
    "HX-06": {"outcome": "change_in_log_unit_cost", "treatment_or_exposure": "optimizer_assignment", "population": "120 eligible synthetic accounts", "period": "declared experiment window", "estimand": "intention-to-treat difference in change in log unit cost", "unit": "log_points", "assignment_or_design": "SEEDED_PERMUTATION_60_OF_120", "uncertainty_method": "NEYMAN_95_PERCENT_INTERVAL", "required_diagnostics": ["assignment_mechanism", "treatment_count", "control_count", "baseline_cost_smd"], "permitted_use": "MAPPED_COST_OR_SAVINGS_MILESTONE_ONLY"},
