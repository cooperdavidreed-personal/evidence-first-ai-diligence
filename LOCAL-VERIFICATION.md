...
- Verified product-source commit: `ebb2b8c4fe4db33224613e22ff4ccfd7f2fa2874`
...
- Python/kernel: `189/189 PASS` in `652.70s`.
...
- Frontend, intake, persistence, policy, hosted-adapter, and data contracts: `111/111 PASS`.
- Local MCP boundary: `9/9 PASS`; read and proposal-only surface preserved.
- TypeScript/Vite build and lazy chunks: `PASS` — shell gzip 118,040 bytes; AtlasGrid payload 203,215 bytes; Helios payload 156,506 bytes.
